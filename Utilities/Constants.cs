...
namespace Utilities
{
    public static class Constants
    {
        ...
        public const string WunderKind_Unsub_Daily_Job = @";WITH CTE_GET_VALID_TRANSACTION_CUSTOMERS AS
                                                        ...
                                                        SELECT DISTINCT CL.FIRST_NAME,CL.LAST_NAME,CL.EMAIL,CTE.AUTOSHIP_PAUSE_DATE UnSubscribedDate  FROM TBL_CUSTOMER_LIST CL WITH (NOLOCK) 
